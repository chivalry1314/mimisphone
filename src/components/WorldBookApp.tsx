...
import { ChevronLeft, Plus, Trash2, Edit2, Check, X, Search, BookOpen, Globe, User } from 'lucide-react';
...
export const WorldBookApp: React.FC<WorldBookAppProps> = ({ onClose }) => {
  const { worldBook, sessions, addWorldEntry, updateWorldEntry, deleteWorldEntry } = useStore();
          ...
          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {/* Trigger Mode Selection (Only for Global) */}
